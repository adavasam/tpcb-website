---
name: ai-slop-check
description: Audit the current design or code for generic AI-template visual tropes (gradients, emoji, default fonts, house-style patterns) and fix any found. Use after producing or updating visual output.
---
