...
description: Commit to a distinctive visual direction (palette, type, tone) when no existing brand or design system is present. Use before wireframing greenfield work.
---
