...
description: Audit a design or page for WCAG compliance, semantic HTML, keyboard navigation, and motion preferences. Use after producing or updating visual output.
---
