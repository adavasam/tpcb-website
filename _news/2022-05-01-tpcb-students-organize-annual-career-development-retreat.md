...
layout: post
date: 2022-05-01
title: "TPCB Students Organize Annual Career Development Retreat"
...
<figure class="news-figure">
  <img src="{{ '/assets/img/news/career-development-retreat-2022-gotian-keynote.jpg' | relative_url }}" alt="A person stands smiling beside a wall-mounted screen showing a slide headed “The Success Factor” with a numbered list." width="295" height="197" loading="lazy">
  <img src="{{ '/assets/img/news/career-development-retreat-2022-alumni-panel.jpg' | relative_url }}" alt="A small group of people stand talking in a semicircle in a room with a stone fireplace." width="295" height="197" loading="lazy">
  <img src="{{ '/assets/img/news/career-development-retreat-2022-go-karts.jpg' | relative_url }}" alt="Two people ride a red go-kart on an outdoor track lined with tyres." width="295" height="197" loading="lazy">
  <img src="{{ '/assets/img/news/career-development-retreat-2022-painting.jpg' | relative_url }}" alt="Six people in aprons stand in a row, each holding up a painted canvas of a similar blue and gold design." width="295" height="197" loading="lazy">
