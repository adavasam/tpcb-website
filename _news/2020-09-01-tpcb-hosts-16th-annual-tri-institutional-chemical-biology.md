...
layout: post
date: 2020-09-01
title: "TPCB Hosts 16th Annual Tri-Institutional Chemical Biology Symposium Online"
...
<figure class="news-figure">
  <img src="{{ '/assets/img/news/tri-i-symposium-2020-speakers-and-organizers.jpg' | relative_url }}" alt="A grid of video-call tiles, each showing one person in front of a virtual background branded for the 16th Annual Tri-Institutional Chemical Biology Symposium." width="600" height="252" loading="lazy">
  <figcaption>Symposium speakers and organizers (from top left): Prof. Lewis Cantley, Prof. Marcey Waters, Prof. Michael Fischbach, Prof. Livia Eberlin, Mizuho Horioka, Adewola Osunsade, Tandrila Das, Gabriella Chua, Ilana Kotliar, Lucas Repeta, and TPCB Director Prof. Derek Tan</figcaption>
</figure>
...
<figure class="news-figure">
  <img src="{{ '/assets/img/news/tri-i-symposium-2020-cantley-seminar.jpg' | relative_url }}" alt="Screen capture of a video call: a slide headed “Brain Metastasis” with a diagram of a head and brain, beside a small video tile of the speaker." width="295" height="167" loading="lazy">
  <img src="{{ '/assets/img/news/tri-i-symposium-2020-horioka-seminar.jpg' | relative_url }}" alt="Screen capture of a video call: a slide headed “Targeting the oncogenic signaling pathways in uvea melanoma” with a signalling diagram, beside a small video tile of the speaker." width="295" height="167" loading="lazy">
  <img src="{{ '/assets/img/news/tri-i-symposium-2020-osunsade-seminar.jpg' | relative_url }}" alt="Screen capture of a video call: a slide headed “Characterization of H1 variants” with coloured schematics of protein variants, beside a small video tile of the speaker." width="295" height="167" loading="lazy">
  <img src="{{ '/assets/img/news/tri-i-symposium-2020-waters-seminar.jpg' | relative_url }}" alt="Screen capture of a video call: a title slide reading “Using genetic code expansion to investigate protein–protein interactions mediated by lysine methylation and acylation”, with molecular structures, beside a small video tile of the speaker." width="295" height="167" loading="lazy">
  <figcaption>Seminar presentations (from top left) by Prof. Lewis Cantley, Mizuho Horioka, Adewola Osunsade, and Prof. Marcey Waters</figcaption>
</figure>
...
<figure class="news-figure">
  ...
  <img src="{{ '/assets/img/news/tri-i-symposium-2020-berman-poster.jpg' | relative_url }}" alt="Screen capture of a video call: a dark scientific poster of microscopy images and diagrams, with small video tiles of participants alongside." width="295" height="167" loading="lazy">
...
<figure class="news-figure">
  ...
  <img src="{{ '/assets/img/news/tri-i-symposium-2020-rundlet-poster.jpg' | relative_url }}" alt="Screen capture of a video call: a scientific poster of dense structural figures and molecular models, with a column of small video tiles of participants alongside." width="295" height="167" loading="lazy">
...
<figure class="news-figure">
  ...
  <img src="{{ '/assets/img/news/tri-i-symposium-2020-fischbach-seminar.jpg' | relative_url }}" alt="Screen capture of a video call: a slide headed “New Clostridium genetic systems” with plasmid diagrams, beside a video tile of the speaker." width="295" height="167" loading="lazy">
  <figcaption>Poster presentation by TPCB student Chloe Burnside (left) and seminar presentation by Prof. Michael Fischbach (right).</figcaption>
</figure>
...
<figure class="news-figure">
  <img src="{{ '/assets/img/news/tri-i-symposium-2020-das-seminar.jpg' | relative_url }}" alt="Screen capture of a video call: a slide headed “IFITM3 membrane topology, modifications and structure”, beside a small video tile of the speaker." width="295" height="167" loading="lazy">
  <img src="{{ '/assets/img/news/tri-i-symposium-2020-eberlin-seminar.jpg' | relative_url }}" alt="Screen capture of a video call: a slide headed “Intraoperative Diagnosis &amp; Margin Evaluation” showing two operating-room photographs, beside a small video tile of the speaker." width="295" height="167" loading="lazy">
  <figcaption>Seminar presentations by TPCB student Tandrila Das (left) and Prof. Livia Eberlin (right).</figcaption>
</figure>
